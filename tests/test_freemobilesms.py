...
class TestsFreemobilesms(unittest.TestCase):
    ...
    def init_context(self):
        self.app = self.session.setup(Freemobilesms, mock_on_start=False, mock_on_stop=False)
    ...
    def test_set_credentials(self):
        ...
        self.app._update_config.assert_called_with({'userid': 'useriddd', 'apikey': 'apikey'})
    ...
    def test_set_crendetials_invalid_parameters(self):
        ...
        self.assertEqual(str(cm.exception), 'Parameter "userid" is invalid (specified="")')
    ...
    def test_test(self):
        ...
        self.app._get_config = Mock(return_value={"userid": "useriddd", "apikey": "apikey"})
    ...
    def test_on_render_no_credentials(self):
        ...
        self.app.logger.warning.assert_called_with("Unable to send SMS because credentials are not configured")
